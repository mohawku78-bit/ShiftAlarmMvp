...
Write-Host "Automated stop path: .\scripts\run-watch-side-by-side-smoke.ps1 -PhoneSerial $PhoneSerial -WatchSerial $WatchSerial -Mode stop -Clear -Assert"
Write-Host "Automated snooze path: .\scripts\run-watch-side-by-side-smoke.ps1 -PhoneSerial $PhoneSerial -WatchSerial $WatchSerial -Mode snooze -Clear -Assert"
