...
Assert-Contains "WatchAlarmListenerService.kt" $watchListener 'if (!notificationShown)'
...
Assert-Contains "WearAlarmControlListenerService.kt" $phoneControlListener 'cancelBridgeFallbackIfNativeNotificationHandled'
...
Assert-Contains "assert-watch-smoke-result.ps1" $smokeAssertScript 'watch showed notification controls'
