...
Assert-Contains "WatchAlarmActionReceiver.kt" $watchActionReceiver 'WatchAlarmRingingService.stopKeepingNotification'
Assert-Contains "WatchAlarmActionReceiver.kt" $watchActionReceiver 'restoreIfPhoneAckMissing'
Assert-Contains "WatchAlarmActionReceiver.kt" $watchActionReceiver 'ringingRestored = WatchAlarmRingingService.start'
